...
public class SwipeListViewTouchListener implements View.OnTouchListener {
	private static final String tag = SwipeListViewTouchListener.class.getCanonicalName();
	...
	public boolean onTouch(View view, MotionEvent motionEvent) {
		...
		case MotionEvent.ACTION_MOVE: {
			...
			try {
				if ((((HeaderViewListAdapter) swipeListView.getAdapter()).getWrappedAdapter()) instanceof SwipeListViewAdapter)
					if (!opened.get(downPosition)) {
						if (((SwipeListViewAdapter) ((HeaderViewListAdapter) swipeListView.getAdapter())
						        .getWrappedAdapter()).getItemRestrictType(downPosition) == SwipeListView.DISABLE_SWIPE) {
							break;
						}
			...
			if (deltaMode > slop && swipeCurrentAction == SwipeListView.SWIPE_ACTION_NONE && velocityY < velocityX) {
				Log.d(tag, "delta Mode " + deltaMode + " slop " + slop);
				swiping = true;
	...
	public void move(float deltaX) {
		...
		Log.d("swipeListView", "Delta " + deltaX + " Restricted Right offset " + (viewWidth - rightOffset)
