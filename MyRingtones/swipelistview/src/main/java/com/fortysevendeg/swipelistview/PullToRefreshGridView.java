...
public class PullToRefreshGridView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mGridView = new PTRGridView(context);

        SetUpLayout();
    }

    /**
     * Set up layout for all view
     * */

    private void SetUpLayout() {
        LayoutParams refreshViewParam = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        refreshViewParam.addRule(ALIGN_PARENT_TOP);
        addView(mRefreshView, refreshViewParam);
        LayoutParams gridViewParam = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        gridViewParam.addRule(BELOW, mRefreshView.getId());
        addView(mGridView,gridViewParam);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mGridView.getFirstVisiblePosition() == 0 && mRefreshState != REFRESHING) {
...
//            mRefreshView.setVisibility(View.GONE);
    ...
    public class PTRGridView extends GridView implements OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            if (mCurrentScrollState == SCROLL_STATE_TOUCH_SCROLL && mRefreshState != REFRESHING) {
                ...
                Log.d("PullToRefresh", "On Scroll Flip Animation " + mRefreshState);
            } else if (mCurrentScrollState == SCROLL_STATE_FLING && firstVisibleItem == 0
                    && mRefreshState != REFRESHING) {
                setSelection(1);
                mBounceHack = true;
                Log.d("PullToRefresh", "On SCROLL_STATE_FLING 1 " + SCROLL_STATE_FLING);
            } else if (mBounceHack && mCurrentScrollState == SCROLL_STATE_FLING) {
                setSelection(1);
                Log.d("PullToRefresh", "On SCROLL_STATE_FLING 2 " + SCROLL_STATE_FLING);
            }
