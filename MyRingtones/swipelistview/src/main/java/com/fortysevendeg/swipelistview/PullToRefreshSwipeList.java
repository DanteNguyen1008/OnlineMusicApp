...
public class PullToRefreshSwipeList extends SwipeListView implements
		OnScrollListener {
	...
	public PullToRefreshSwipeList(Context context, int swipeBackview,
			int swipeFontView) {
		super(context, swipeBackview, swipeFontView);
		init(context);
	}

	public PullToRefreshSwipeList(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
